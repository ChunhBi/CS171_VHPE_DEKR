...
JOINT_PAIRS = [('OP Neck', 'OP MidHip'), ('OP RHip', 'OP RKnee'), ('OP RKnee', 'OP RAnkle'), ('OP MidHip', 'OP RHip'), ('OP MidHip', 'OP LHip'), ('OP LHip', 'OP LKnee'),
...
JOINT_IDS = {OP_21_JOINTS[i]: i for i in range(len(OP_21_JOINTS))}

JOINT_ID_PAIRS = [(JOINT_IDS[first], JOINT_IDS[second]) for first, second in JOINT_PAIRS]
...
class SMPL(_SMPL):
    ...
    def __init__(self, *args, **kwargs):
        ...
        joints = [JOINT_MAP[i] for i in OP_21_JOINTS]
